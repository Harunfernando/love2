...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hallo Sahabatku", "Aku ada pertanyaan nih buat kamu", "question").then(function () {
                  ...
                  Swal.fire(`Makasih ya udah sayang sama ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      ...
                      if (result.isConfirmed) {
                        ...
                        Swal.fire('yahhh, emang ga kangen sama sahabat sendiri', '', 'error').then(function () {
